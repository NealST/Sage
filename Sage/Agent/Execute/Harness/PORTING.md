...
| Phase | 文件数 | ✅ | 🟡 | 🟥 | ⬜ | ⛔/💤 |
|---|---:|---:|---:|---:|---:|---:|
| Phase 1 | 94 | 21 | 1 | 0 | 72 | 0 |
| Phase 2 | 26 | 7 | 1 | 0 | 17 | 0 |
| Phase 3 | 82 | 0 | 0 | 0 | 78 | 0 |
| Phase 4 | 112 | 0 | 8 | 0 | 63 | 0 |
| Phase 5 | 155 | 0 | 4 | 0 | 151 | 0 |
| Phase 6 | 49 | 0 | 0 | 0 | 36 | 0 |
| Phase 7 | 126 | 0 | 0 | 0 | 126 | 0 |
| Phase 8 | 70 | 2 | 13 | 0 | 55 | 0 |
| Phase 9 | 73 | 0 | 0 | 0 | 73 | 0 |
| Phase 10 | 38 | 0 | 0 | 0 | 38 | 0 |

## Phase 1

| codex 文件 | 行数 | Swift 文件 | 状态 | 备注 |
|---|---:|---|---|---|
| `core/src/util.rs` | 101 | - | ⬜ 未开始 |  |
| `core/src/utils/json.rs` | 22 | - | ⬜ 未开始 |  |
| `core/src/utils/mod.rs` | 2 | - | ⬜ 未开始 |  |
| `core/src/utils/path_utils.rs` | 1 | - | ⬜ 未开始 |  |
| `async-utils/src/backoff.rs` | 17 | - | ⬜ 未开始 |  |
| `async-utils/src/lib.rs` | 93 | - | ⬜ 未开始 |  |
| `protocol/src/account.rs` | 259 | - | ⬜ 未开始 |  |
| `protocol/src/agent_path.rs` | 240 | - | ⬜ 未开始 |  |
| `protocol/src/approvals.rs` | 548 | - | ⬜ 未开始 |  |
| `protocol/src/auth.rs` | 249 | - | ⬜ 未开始 |  |
| `protocol/src/capabilities.rs` | 51 | - | ⬜ 未开始 |  |
| `protocol/src/codex_error_info.rs` | 83 | - | ⬜ 未开始 |  |
| `protocol/src/config_types.rs` | 980 | - | ⬜ 未开始 |  |
| `protocol/src/dynamic_tools.rs` | 175 | - | ⬜ 未开始 |  |
| `protocol/src/environment.rs` | 101 | - | ⬜ 未开始 |  |
| `protocol/src/error.rs` | 890 | - | ⬜ 未开始 |  |
| `protocol/src/exec_output.rs` | 169 | - | ⬜ 未开始 |  |
| `protocol/src/items.rs` | 869 | - | ⬜ 未开始 |  |
| `protocol/src/legacy_events.rs` | 685 | - | ⬜ 未开始 |  |
| `protocol/src/lib.rs` | 56 | - | ⬜ 未开始 |  |
| `protocol/src/local_media.rs` | 96 | - | ⬜ 未开始 |  |
| `protocol/src/mcp.rs` | 587 | - | ⬜ 未开始 |  |
...
| `protocol/src/models/configuration_update.rs` | 17 | - | ⬜ 未开始 |  |
| `protocol/src/models/executed_tool_calls.rs` | 612 | - | ⬜ 未开始 |  |
| `protocol/src/models/item_metadata.rs` | 11 | `protocol/src/models/item_metadata.swift` | ✅ faithful |  |
| `protocol/src/models.rs` | 4,565 | - | ⬜ 未开始 |  |
| `protocol/src/network_policy.rs` | 22 | - | ⬜ 未开始 |  |
| `protocol/src/num_format.rs` | 29 | `protocol/src/num_format.swift` | ✅ faithful |  |
| `protocol/src/openai_models/access_programs.rs` | 31 | - | ⬜ 未开始 |  |
| `protocol/src/openai_models/guardian.rs` | 179 | - | ⬜ 未开始 |  |
| `protocol/src/openai_models/guardian_v2.rs` | 48 | - | ⬜ 未开始 |  |
| `protocol/src/openai_models/reasoning_effort.rs` | 44 | - | ⬜ 未开始 |  |
| `protocol/src/openai_models.rs` | 1,935 | - | ⬜ 未开始 |  |
| `protocol/src/parse_command.rs` | 31 | `protocol/src/parse_command.swift` | ✅ faithful |  |
| `protocol/src/permission_profile_intersection.rs` | 425 | - | ⬜ 未开始 |  |
| `protocol/src/permission_profile_snapshot.rs` | 128 | - | ⬜ 未开始 |  |
| `protocol/src/permissions/deny_read_validator.rs` | 102 | - | ⬜ 未开始 |  |
| `protocol/src/permissions/target.rs` | 195 | - | ⬜ 未开始 |  |
| `protocol/src/permissions/windows_glob.rs` | 44 | - | ⬜ 未开始 |  |
| `protocol/src/permissions.rs` | 4,488 | - | ⬜ 未开始 |  |
| `protocol/src/plan_tool.rs` | 29 | `protocol/src/plan_tool.swift` | ✅ faithful |  |
| `protocol/src/protocol.rs` | 6,444 | - | ⬜ 未开始 |  |
| `protocol/src/realtime.rs` | 59 | - | ⬜ 未开始 |  |
| `protocol/src/request_permissions.rs` | 99 | - | ⬜ 未开始 |  |
| `protocol/src/request_user_input.rs` | 103 | - | ⬜ 未开始 |  |
...
| `protocol/src/review_format.rs` | 82 | - | ⬜ 未开始 |  |
| `protocol/src/sandbox.rs` | 42 | - | ⬜ 未开始 |  |
| `protocol/src/sanitized_git_url.rs` | 159 | - | ⬜ 未开始 |  |
...
| `protocol/src/shell_environment.rs` | 322 | - | ⬜ 未开始 |  |
...
| `protocol/src/turn_input.rs` | 252 | - | ⬜ 未开始 |  |
| `protocol/src/user_input.rs` | 126 | - | ⬜ 未开始 |  |
...
| `utils/audio/src/lib.rs` | 265 | - | ⬜ 未开始 |  |
| `utils/cache/src/lib.rs` | 193 | - | ⬜ 未开始 |  |
| `utils/git-discovery/src/lib.rs` | 120 | - | ⬜ 未开始 |  |
| `utils/home-dir/src/lib.rs` | 134 | - | ⬜ 未开始 |  |
| `utils/image/src/error.rs` | 63 | - | ⬜ 未开始 |  |
| `utils/image/src/lib.rs` | 462 | - | ⬜ 未开始 |  |
| `utils/output-truncation/src/lib.rs` | 215 | - | ⬜ 未开始 |  |
...
| `utils/path-utils/src/env.rs` | 19 | - | ⬜ 未开始 |  |
| `utils/path-utils/src/lib.rs` | 242 | - | ⬜ 未开始 |  |
| `utils/path-utils/src/system_commands.rs` | 166 | - | ⬜ 未开始 |  |
| `utils/plugins/src/lib.rs` | 53 | - | ⬜ 未开始 |  |
| `utils/plugins/src/mcp_connector.rs` | 20 | - | ⬜ 未开始 |  |
| `utils/plugins/src/mention_syntax.rs` | 7 | - | ⬜ 未开始 |  |
| `utils/plugins/src/plugin_namespace.rs` | 366 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/assistant_text.rs` | 130 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/citation.rs` | 179 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/inline_hidden_tag.rs` | 323 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/lib.rs` | 23 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/proposed_plan.rs` | 212 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/stream_text.rs` | 36 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/tagged_line_parser.rs` | 249 | - | ⬜ 未开始 |  |
| `utils/stream-parser/src/utf8_stream.rs` | 333 | - | ⬜ 未开始 |  |
| `utils/string/src/json.rs` | 169 | - | ⬜ 未开始 |  |
| `utils/string/src/lib.rs` | 166 | - | ⬜ 未开始 |  |
| `utils/string/src/truncate.rs` | 156 | - | ⬜ 未开始 |  |
...
| `apply-patch/src/standalone_executable.rs` | 90 | - | ⬜ 未开始 | 适配项：Sage 进程内调用，无独立可执行 |
...
| `file-system/src/environment_accessor.rs` | 280 | - | ⬜ 未开始 |  |
| `file-system/src/exec_permission_profile_serde.rs` | 22 | - | ⬜ 未开始 |  |
| `file-system/src/find_up.rs` | 126 | - | ⬜ 未开始 |  |
| `file-system/src/lib.rs` | 712 | `file-system/src/lib.swift` | 🟡 partial |  |
| `git-utils/src/apply.rs` | 855 | - | ⬜ 未开始 |  |
| `git-utils/src/baseline.rs` | 756 | - | ⬜ 未开始 |  |
| `git-utils/src/branch.rs` | 256 | - | ⬜ 未开始 |  |
| `git-utils/src/errors.rs` | 35 | - | ⬜ 未开始 |  |
| `git-utils/src/fsmonitor.rs` | 129 | - | ⬜ 未开始 |  |
| `git-utils/src/git_process.rs` | 106 | - | ⬜ 未开始 |  |
| `git-utils/src/info.rs` | 1,208 | - | ⬜ 未开始 |  |
| `git-utils/src/lib.rs` | 57 | - | ⬜ 未开始 |  |
| `git-utils/src/operations.rs` | 172 | - | ⬜ 未开始 |  |
| `git-utils/src/platform.rs` | 37 | - | ⬜ 未开始 |  |
| `git-utils/src/status.rs` | 83 | - | ⬜ 未开始 |  |
| `git-utils/src/trust.rs` | 183 | - | ⬜ 未开始 |  |
| `git-utils/src/worktree.rs` | 178 | - | ⬜ 未开始 |  |

## Phase 3

| codex 文件 | 行数 | Swift 文件 | 状态 | 备注 |
|---|---:|---|---|---|
| `core/src/apply_patch.rs` | 97 | - | ⬜ 未开始 |  |
| `core/src/command_canonicalization.rs` | 42 | - | ⬜ 未开始 |  |
| `core/src/exec.rs` | 1,276 | - | ⬜ 未开始 |  |
| `core/src/exec_env.rs` | 117 | - | ⬜ 未开始 |  |
...
| `core/src/safety.rs` | 144 | - | ⬜ 未开始 |  |
| `core/src/sandbox_tags.rs` | 114 | - | ⬜ 未开始 |  |
| `core/src/sandboxing/mod.rs` | 218 | - | ⬜ 未开始 |  |
| `core/src/shell.rs` | 104 | - | ⬜ 未开始 |  |
| `core/src/shell_snapshot.rs` | 1,169 | - | ⬜ 未开始 |  |
| `core/src/shell_snapshot_sandbox.rs` | 224 | - | ⬜ 未开始 |  |
| `core/src/spawn.rs` | 137 | - | ⬜ 未开始 |  |
| `core/src/unified_exec/async_watcher.rs` | 482 | - | ⬜ 未开始 |  |
...
| `core/src/unified_exec/process.rs` | 652 | - | ⬜ 未开始 |  |
| `core/src/unified_exec/process_manager.rs` | 1,881 | - | ⬜ 未开始 |  |
...
| `core/src/user_shell_command.rs` | 44 | - | ⬜ 未开始 |  |
| `execpolicy/src/amend.rs` | 337 | - | ⬜ 未开始 |  |
| `execpolicy/src/decision.rs` | 27 | - | ⬜ 未开始 |  |
| `execpolicy/src/error.rs` | 101 | - | ⬜ 未开始 |  |
| `execpolicy/src/execpolicycheck.rs` | 95 | - | ⬜ 未开始 |  |
| `execpolicy/src/executable_name.rs` | 29 | - | ⬜ 未开始 |  |
| `execpolicy/src/lib.rs` | 33 | - | ⬜ 未开始 |  |
| `execpolicy/src/main.rs` | 18 | - | ⬜ 未开始 |  |
| `execpolicy/src/parser.rs` | 473 | - | ⬜ 未开始 |  |
| `execpolicy/src/policy.rs` | 412 | - | ⬜ 未开始 |  |
| `execpolicy/src/rule.rs` | 306 | - | ⬜ 未开始 |  |
| `execpolicy/src/sandbox_migration.rs` | 123 | - | ⬜ 未开始 |  |
| `sandboxing/src/bwrap.rs` | 195 | - | ⛔ excluded | platform: Linux |
| `sandboxing/src/denial.rs` | 72 | - | ⬜ 未开始 |  |
| `sandboxing/src/landlock.rs` | 115 | - | ⛔ excluded | platform: Linux |
| `sandboxing/src/lib.rs` | 98 | - | ⬜ 未开始 |  |
| `sandboxing/src/manager.rs` | 802 | - | ⬜ 未开始 |  |
| `sandboxing/src/policy_transforms.rs` | 670 | - | ⬜ 未开始 |  |
| `sandboxing/src/seatbelt.rs` | 1,122 | - | ⬜ 未开始 |  |
| `sandboxing/src/seatbelt_daemon.rs` | 24 | - | ⬜ 未开始 |  |
| `sandboxing/src/seatbelt_scratch.rs` | 69 | - | ⬜ 未开始 |  |
| `sandboxing/src/spawn.rs` | 141 | - | ⬜ 未开始 |  |
| `sandboxing/src/terminal_queries.rs` | 104 | - | ⬜ 未开始 |  |
| `sandboxing/src/violation.rs` | 300 | - | ⬜ 未开始 |  |
| `sandboxing/src/windows.rs` | 401 | - | ⛔ excluded | platform: Windows |
| `sandboxing/src/windows_mxc.rs` | 22 | - | ⛔ excluded | platform: Windows |
| `shell-command/src/bash.rs` | 565 | - | ⬜ 未开始 |  |
| `shell-command/src/command_safety/is_dangerous_command.rs` | 323 | - | ⬜ 未开始 |  |
| `shell-command/src/command_safety/mod.rs` | 9 | - | ⬜ 未开始 |  |
| `shell-command/src/command_safety/powershell_parser.rs` | 373 | - | ⬜ 未开始 | 适配项：macOS 不需要 PowerShell 解析 |
| `shell-command/src/command_safety/powershell_tree_sitter.rs` | 482 | - | ⬜ 未开始 | 适配项：macOS 不需要 PowerShell 解析 |
| `shell-command/src/command_safety/windows_dangerous_commands.rs` | 771 | - | ⬜ 未开始 | 适配项：Windows 危险命令表 |
| `shell-command/src/lib.rs` | 14 | - | ⬜ 未开始 |  |
| `shell-command/src/parse_command.rs` | 2,766 | - | ⬜ 未开始 |  |
| `shell-command/src/powershell.rs` | 291 | - | ⬜ 未开始 | 适配项：macOS 仅需 bash/zsh/sh，保留同名文件标注 |
| `shell-command/src/shell_detect.rs` | 495 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot.rs` | 112 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot_capture.rs` | 408 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot_credentials.rs` | 342 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot_exports.rs` | 81 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot_literals.rs` | 715 | - | ⬜ 未开始 |  |
| `shell-command/src/shell_snapshot_render.rs` | 106 | - | ⬜ 未开始 |  |
| `shell-command/src/startup.rs` | 30 | - | ⬜ 未开始 |  |
| `utils/pty/src/child.rs` | 96 | - | ⬜ 未开始 |  |
| `utils/pty/src/child_command.rs` | 189 | - | ⬜ 未开始 |  |
| `utils/pty/src/lib.rs` | 57 | - | ⬜ 未开始 |  |
| `utils/pty/src/macos_child.rs` | 368 | - | ⬜ 未开始 |  |
| `utils/pty/src/pipe.rs` | 370 | - | ⬜ 未开始 |  |
| `utils/pty/src/process.rs` | 481 | - | ⬜ 未开始 |  |
| `utils/pty/src/process_group.rs` | 309 | - | ⬜ 未开始 |  |
| `utils/pty/src/pty.rs` | 563 | - | ⬜ 未开始 |  |
| `utils/pty/src/unix_io.rs` | 109 | - | ⬜ 未开始 |  |
| `utils/pty/src/win/conpty.rs` | 192 | - | ⬜ 未开始 |  |
| `utils/pty/src/win/job.rs` | 232 | - | ⬜ 未开始 |  |
| `utils/pty/src/win/mod.rs` | 181 | - | ⬜ 未开始 |  |
| `utils/pty/src/win/procthreadattr.rs` | 127 | - | ⬜ 未开始 |  |
| `utils/pty/src/win/psuedocon.rs` | 387 | - | ⬜ 未开始 |  |
| `utils/pty/src/windows_input.rs` | 35 | - | ⬜ 未开始 |  |
...
| `core/src/tools/events.rs` | 885 | - | ⬜ 未开始 |  |
| `core/src/tools/executed_tool_calls/mcp_attribution.rs` | 169 | - | ⬜ 未开始 |  |
| `core/src/tools/executed_tool_calls/request_metadata.rs` | 441 | - | ⬜ 未开始 |  |
| `core/src/tools/executed_tool_calls/seen_ids.rs` | 133 | - | ⬜ 未开始 |  |
| `core/src/tools/executed_tool_calls.rs` | 629 | - | ⬜ 未开始 |  |
...
| `core/src/tools/handlers/mcp.rs` | 882 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mcp_resource/list_mcp_resource_templates.rs` | 102 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mcp_resource/list_mcp_resources.rs` | 100 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mcp_resource/read_mcp_resource.rs` | 99 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mcp_resource.rs` | 414 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mcp_resource_spec.rs` | 97 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/mod.rs` | 616 | - | ⬜ 未开始 |  |
...
| `core/src/tools/handlers/request_user_input.rs` | 175 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/request_user_input_async.rs` | 144 | - | ⬜ 未开始 |  |
...
| `core/src/tools/handlers/tool_search.rs` | 487 | - | ⬜ 未开始 |  |
...
| `core/src/tools/lifecycle.rs` | 175 | - | ⬜ 未开始 |  |
| `core/src/tools/mod.rs` | 147 | - | ⬜ 未开始 |  |
...
| `core/src/tools/registry.rs` | 851 | - | ⬜ 未开始 |  |
| `core/src/tools/router.rs` | 385 | - | ⬜ 未开始 |  |
...
| `core/src/tools/runtimes/unified_exec.rs` | 975 | - | ⬜ 未开始 |  |
...
| `network-proxy/src/environment_policy.rs` | 92 | - | ⬜ 未开始 | 策略类型层 |
...
| `core/src/config/edit/document_helpers.rs` | 343 | - | ⬜ 未开始 |  |
| `core/src/config/edit.rs` | 1,001 | - | ⬜ 未开始 |  |
| `core/src/config/managed_features.rs` | 340 | - | ⬜ 未开始 |  |
| `core/src/config/metrics.rs` | 10 | - | ⬜ 未开始 |  |
| `core/src/config/mod.rs` | 4,893 | - | ⬜ 未开始 |  |
...
| `core/src/config/otel.rs` | 118 | - | ⬜ 未开始 |  |
...
| `core/src/context/contextual_user_message.rs` | 112 | - | ⬜ 未开始 |  |
...
| `core/src/context/guardian_context_mode.rs` | 48 | - | ⬜ 未开始 |  |
...
| `core/src/context/guardian_review_evidence.rs` | 312 | - | ⬜ 未开始 |  |
...
| `core/src/context/mod.rs` | 125 | - | ⬜ 未开始 |  |
...
| `core/src/context/world_state/permissions.rs` | 131 | - | ⬜ 未开始 |  |
...
| `core/src/context/world_state/tools.rs` | 170 | - | ⬜ 未开始 |  |
| `core/src/context_manager/history.rs` | 1,225 | - | ⬜ 未开始 |  |
| `core/src/context_manager/history_user_authorization.rs` | 105 | - | ⬜ 未开始 |  |
...
| `core/src/mcp.rs` | 394 | - | ⬜ 未开始 |  |
| `core/src/mcp_openai_file.rs` | 698 | - | ⬜ 未开始 |  |
| `core/src/mcp_skill_dependencies.rs` | 531 | - | ⬜ 未开始 |  |
...
| `core/src/mcp_tool_call.rs` | 2,504 | - | ⬜ 未开始 |  |
| `core/src/mcp_tool_exposure.rs` | 189 | - | ⬜ 未开始 |  |
...
| `core/src/session/handlers.rs` | 681 | - | ⬜ 未开始 |  |
| `core/src/session/inject.rs` | 193 | - | ⬜ 未开始 |  |
| `core/src/session/input_queue.rs` | 669 | - | ⬜ 未开始 |  |
| `core/src/session/mcp.rs` | 1,206 | - | ⬜ 未开始 |  |
| `core/src/session/mcp_prewarm.rs` | 82 | - | ⬜ 未开始 |  |
| `core/src/session/mcp_refresh.rs` | 56 | - | ⬜ 未开始 |  |
| `core/src/session/mcp_runtime.rs` | 381 | - | ⬜ 未开始 |  |
| `core/src/session/mod.rs` | 5,130 | - | ⬜ 未开始 |  |
| `core/src/session/plugin_selection.rs` | 32 | - | ⬜ 未开始 |  |
| `core/src/session/reasoning_effort.rs` | 162 | - | ⬜ 未开始 |  |
| `core/src/session/retained_context.rs` | 35 | - | ⬜ 未开始 |  |
| `core/src/session/review.rs` | 229 | - | ⬜ 未开始 |  |
| `core/src/session/rollout_budget.rs` | 34 | - | ⬜ 未开始 |  |
| `core/src/session/rollout_reconstruction.rs` | 575 | - | ⬜ 未开始 |  |
| `core/src/session/session.rs` | 1,915 | - | ⬜ 未开始 |  |
| `core/src/session/startup.rs` | 37 | - | ⬜ 未开始 |  |
| `core/src/session/step_activation.rs` | 472 | - | ⬜ 未开始 |  |
| `core/src/session/step_context.rs` | 57 | - | ⬜ 未开始 |  |
| `core/src/session/step_settings.rs` | 347 | - | ⬜ 未开始 |  |
| `core/src/session/submission.rs` | 18 | - | ⬜ 未开始 |  |
| `core/src/session/thread_settings.rs` | 152 | - | ⬜ 未开始 |  |
| `core/src/session/time_reminder.rs` | 202 | - | ⬜ 未开始 |  |
| `core/src/session/token_budget.rs` | 248 | - | ⬜ 未开始 |  |
| `core/src/session/turn.rs` | 3,105 | `session/turn.swift` | 🟡 partial |  |
| `core/src/session/turn_context.rs` | 1,386 | - | ⬜ 未开始 |  |
| `core/src/session/turn_input.rs` | 765 | - | ⬜ 未开始 |  |
| `core/src/session/turn_suspension.rs` | 119 | - | ⬜ 未开始 |  |
| `core/src/session/world_state.rs` | 295 | - | ⬜ 未开始 |  |
| `core/src/session_startup_prewarm.rs` | 328 | - | ⬜ 未开始 |  |
...
| `core/src/state/session.rs` | 475 | - | ⬜ 未开始 |  |
| `core/src/state/turn.rs` | 254 | - | ⬜ 未开始 |  |
| `core/src/state/turn_token_usage.rs` | 48 | - | ⬜ 未开始 |  |
| `core/src/stream_events_utils.rs` | 586 | - | ⬜ 未开始 |  |
...
| `core/src/tasks/user_shell.rs` | 485 | - | ⬜ 未开始 |  |
...
| `core/src/responses_metadata.rs` | 592 | - | ⬜ 未开始 |  |
| `core/src/responses_retry.rs` | 180 | - | ⬜ 未开始 |  |
| `core/src/web_search.rs` | 30 | - | ⬜ 未开始 |  |
| `codex-api/src/api_bridge.rs` | 318 | - | ⬜ 未开始 |  |
| `codex-api/src/auth.rs` | 104 | - | ⬜ 未开始 |  |
| `codex-api/src/common.rs` | 406 | - | ⬜ 未开始 |  |
| `codex-api/src/endpoint/images.rs` | 403 | - | ⬜ 未开始 |  |
...
| `codex-api/src/error.rs` | 55 | - | ⬜ 未开始 |  |
| `codex-api/src/files.rs` | 887 | - | ⬜ 未开始 |  |
| `codex-api/src/images.rs` | 72 | - | ⬜ 未开始 |  |
| `codex-api/src/lib.rs` | 121 | - | ⬜ 未开始 |  |
| `codex-api/src/provider.rs` | 166 | - | ⬜ 未开始 |  |
...
| `core/src/codex_thread.rs` | 1,065 | - | ⬜ 未开始 |  |
...
| `core/src/thread_manager.rs` | 2,583 | - | ⬜ 未开始 |  |
...
| `rollout/src/compression/read_metrics.rs` | 58 | - | ⬜ 未开始 |  |
| `rollout/src/compression.rs` | 1,403 | - | ⬜ 未开始 |  |
...
| `state/src/lib.rs` | 152 | - | ⬜ 未开始 |  |
| `state/src/log_db.rs` | 884 | - | ⬜ 未开始 |  |
...
| `thread-store/src/in_memory.rs` | 1,204 | - | ⬜ 未开始 |  |
...
| `thread-store/src/local/mod.rs` | 2,137 | - | ⬜ 未开始 |  |
...
| `thread-store/src/local/rollout_migration/legacy_event.rs` | 313 | - | ⬜ 未开始 |  |
...
| `thread-store/src/local/rollout_migration/rollback_plan.rs` | 541 | - | ⬜ 未开始 |  |
...
| `core/src/guardian/input_budget.rs` | 197 | `guardian/input_budget.swift` | 🟡 partial |  |
| `core/src/guardian/mod.rs` | 208 | - | ⬜ 未开始 |  |
...
| `hooks/src/engine/command_runner.rs` | 466 | - | ⬜ 未开始 |  |
...
| codex 文件 | 行数 | Swift 文件 | 状态 | 备注 |
|---|---:|---|---|---|
| `core/src/agent/agent_resolver.rs` | 37 | - | ⬜ 未开始 |  |
| `core/src/agent/api.rs` | 243 | - | ⬜ 未开始 |  |
| `core/src/agent/child_config.rs` | 365 | - | ⬜ 未开始 |  |
| `core/src/agent/control/api.rs` | 289 | - | ⬜ 未开始 |  |
...
| `core/src/agent/control/execution.rs` | 105 | - | ⬜ 未开始 |  |
| `core/src/agent/control/inspection.rs` | 30 | - | ⬜ 未开始 |  |
...
| `core/src/agent/control/runtime.rs` | 69 | - | ⬜ 未开始 |  |
| `core/src/agent/control/sender_context.rs` | 83 | - | ⬜ 未开始 |  |
| `core/src/agent/control/service_tier.rs` | 21 | - | ⬜ 未开始 |  |
| `core/src/agent/control/spawn.rs` | 1,380 | - | ⬜ 未开始 |  |
| `core/src/agent/control/spawn_guard.rs` | 75 | - | ⬜ 未开始 |  |
| `core/src/agent/control/target.rs` | 58 | - | ⬜ 未开始 |  |
| `core/src/agent/control/user_authorization.rs` | 284 | - | ⬜ 未开始 |  |
| `core/src/agent/control/watch.rs` | 61 | - | ⬜ 未开始 |  |
| `core/src/agent/control.rs` | 904 | - | ⬜ 未开始 |  |
...
| `core/src/agent_message_board.rs` | 190 | - | ⬜ 未开始 |  |
...
| `core/src/tools/code_mode/execute_handler.rs` | 245 | - | ⬜ 未开始 |  |
| `core/src/tools/code_mode/execute_spec.rs` | 104 | - | ⬜ 未开始 |  |
...
| `core/src/tools/code_mode/telemetry.rs` | 148 | - | ⬜ 未开始 |  |
| `core/src/tools/code_mode/wait_handler.rs` | 231 | - | ⬜ 未开始 |  |
...
| `core/src/tools/handlers/multi_agents/close_agent.rs` | 133 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents/resume_agent.rs` | 177 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents/send_input.rs` | 173 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents/spawn.rs` | 239 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents/wait.rs` | 334 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents.rs` | 99 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents_common.rs` | 157 | - | ⬜ 未开始 |  |
...
| `core/src/tools/handlers/multi_agents_v2/interrupt_agent.rs` | 104 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents_v2/list_agents.rs` | 109 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents_v2/message_tool.rs` | 100 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents_v2/send_message.rs` | 57 | - | ⬜ 未开始 |  |
| `core/src/tools/handlers/multi_agents_v2/spawn.rs` | 330 | - | ⬜ 未开始 |  |
...
| `core/src/realtime_conversation.rs` | 2,709 | - | ⬜ 未开始 | deferred: 语音 realtime，Sage 无此形态 |
...
| `otel/src/events/session_telemetry.rs` | 1,358 | - | ⬜ 未开始 |  |
| `otel/src/events/shared.rs` | 70 | - | ⬜ 未开始 |  |
| `otel/src/lib.rs` | 94 | - | ⬜ 未开始 |  |
| `otel/src/metrics/client.rs` | 677 | - | ⬜ 未开始 |  |
| `otel/src/metrics/config.rs` | 135 | - | ⬜ 未开始 |  |
| `otel/src/metrics/error.rs` | 46 | - | ⬜ 未开始 |  |
| `otel/src/metrics/mod.rs` | 58 | - | ⬜ 未开始 |  |
| `otel/src/metrics/names.rs` | 70 | - | ⬜ 未开始 |  |
...
| `otel/src/provider.rs` | 851 | - | ⬜ 未开始 |  |
| `otel/src/targets.rs` | 11 | - | ⬜ 未开始 |  |
| `otel/src/tool_result.rs` | 114 | - | ⬜ 未开始 |  |
