...
extension SkillsManageView {
    ...
    /// deferred dismissal or selection switch. A failed save keeps the
    /// sheet open — the pane surfaces the error itself.
    ...
    func locationCaption(for skill: SkillRecord) -> String {
        ...
        switch skill.scope {
        case .global:
            location = "Available in every workspace"

        case .project:
            location = "Only used in “\(projectName)”"
        }
